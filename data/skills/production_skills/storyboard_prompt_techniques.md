...
本手册的“画面描述完整保留”指保留叙事主体、空间、动作和因果，不要求复制违反 global_content_constraints.md 的血液颜色。旧分镜中的红色血液、红色伤口、血色海水及红色反弹光必须先改为遮挡包扎、必要的少量绿色或黑色血迹、自然环境色。分镜提示词不得一边保留红色血液正向描写，一边附加禁止词；正常红衣、红灯、肤色不变。
